...
algorithmSetup$inputDataClean = t145325.clean
...
algorithmSetup$inputRecordTotalNr = nrow(algorithmSetup$inputDataClean)
...
# echo:
algorithmSetup$combinationNrPerTimePoint
algorithmSetup$outputSize
paste('outputSize (if float)', algorithmSetup$outputSize * 4 / 1024 / 1024, "MB")
